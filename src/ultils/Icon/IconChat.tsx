...
const HomeActiveIcon = forwardRef(({ className, width = '1em', height = '1em' }: IconsProps, ref: ForwardedRef<any>) => {
    return (
        <svg width={width} data-e2e="" height={height} viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path
                fillRule="evenodd"
                clipRule="evenodd"
